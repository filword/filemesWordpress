...
<?php if($values = get_post_custom_values("titulo_repro1")) { echo $values[0]; } else { echo _e('Server 1', 'mundothemes'); } ?>
</a>
</li>
<?php } ?>
<?php if($player2 = get_post_custom_values("embed_pelicula2")) { ?>
<li><a href="#div3"><?php if($values = get_post_custom_values("titulo_repro2")) { echo $values[0]; } else { echo _e('Server 2', 'mundothemes'); } ?></a></li>
<?php }  ?>
<?php if($player3 = get_post_custom_values("embed_pelicula3")) { ?>
<li><a href="#div4"><?php if($values = get_post_custom_values("titulo_repro3")) { echo $values[0]; } else { echo _e('Server 3', 'mundothemes'); } ?></a></li>
<?php } ?> 
<?php if($player4 = get_post_custom_values("embed_pelicula4")) { ?>
<li><a href="#div5"><?php if($values = get_post_custom_values("titulo_repro4")) { echo $values[0]; } else { echo _e('Server 4', 'mundothemes'); } ?></a></li>
<?php } ?>
<?php if($player5 = get_post_custom_values("embed_pelicula5")) { ?>
<li><a href="#div6"><?php if($values = get_post_custom_values("titulo_repro5")) { echo $values[0]; } else { echo _e('Server 5', 'mundothemes'); } ?></a></li>
<?php } ?>
<?php if($player6 = get_post_custom_values("embed_pelicula6")) { ?>
<li><a href="#div7"><?php if($values = get_post_custom_values("titulo_repro6")) { echo $values[0]; } else { echo _e('Server 6', 'mundothemes'); } ?></a></li>
<?php } ?>
<?php if($player7 = get_post_custom_values("embed_pelicula7")) { ?>
<li><a href="#div8"><?php if($values = get_post_custom_values("titulo_repro7")) { echo $values[0]; } else { echo _e('Server 7', 'mundothemes'); } ?></a></li>
<?php } ?>
<?php if($player8 = get_post_custom_values("embed_pelicula8")) { ?>
<li><a href="#div9"><?php if($values = get_post_custom_values("titulo_repro8")) { echo $values[0]; } else { echo _e('Server 8', 'mundothemes'); } ?></a></li>
<?php } ?>
</ul>
</div>
<?php } else { ?>
